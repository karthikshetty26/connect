...
export const SITE_CONFIG = {
  ...
  socialLinks: [
    ...
    },
    {
      ...
      name: "GitHub",
      type: "GitHub",
      description: "Code behind my projects and experiments.",
      linkText: "View Code",
    },
    {
      isModal: true,
      name: "Read Articles",
      type: "Blog",
      description: "What building teaches me along the way.",
    ...
    },
    {
      ...
      name: "YouTube",
      type: "YouTube",
      description: "Just me trying things - vlogs, reviews, random stuff.",
      linkText: "Subscribe",
    },
    {
      ...
      name: "Instagram",
      type: "Instagram",
      description: "Personal side, nothing to do with code.",
      linkText: "Follow",
    },
    {
